...
def select_name_and_series_subgenres_of_authors
  "SELECT authors.name, subgenres.name FROM authors, subgenres LEFT OUTER JOIN series ON authors.id = series.author_id ORDER BY authors.name AND subgenres.name;"
end
